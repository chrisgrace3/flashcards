...
10.times do
  ...
  PossibleAnswer.create!(answer: "using a variable and then defining it", card_id: 9)
  ...
  PossibleAnswer.create!(answer: "a function that creates many objects with similar properties", card_id: 10)
  ...
  PossibleAnswer.create!(answer: "it's a free-for-all", card_id: 12)
  ...
  PossibleAnswer.create!(answer: "this means that the language supports constructing new functions during the execution of a program, storing them in data structures, passing them as arguments to other functions, and returning them as the values of other functions.", card_id: 13)
